...
async def seed():
    ...
    await init_beanie(database=client[settings.DB_NAME], document_models=[User, Product])
    ...
    dummy_products = [
      ...
      },
      {
        ...
        "price": 15.99,
        "description": "Casual slim fit tees with soft fabric and comfortable wearing experience.",
        "category": "men's clothing",
      ...
      },
      {
        ...
        "price": 109,
        "description": "3D NAND flash Remarkable transfer speeds faster bootup and improved overall system performance.",
        "category": "electronics",
        "images": ["https://fakestoreapi.com/img/71kWymZ+c+L._AC_SX679_t.png"],
        "stock": 55
      },
      {
        "name": "WD 4TB Gaming Drive PS4",
        "price": 114,
      ...
      {
        "name": "Acer SB220Q bi 21.5-inch Monitor",
        "price": 599,
        "description": "21. 5 inches Full HD IPS display. Radeon free Sync technology. Ultra-thin design.",
        "category": "electronics",
      ...
      },
      {
        ...
        "price": 999.99,
        "description": "Super Ultrawide 32:9 Curved Gaming Monitor. 144Hz high refresh rate.",
        "category": "electronics",
      ...
      },
      {
        ...
        "price": 56.99,
        "description": "Detachable Liner Fabric: Warm Fleece. Sking Friendly, Lightweight and Warm.",
      ...
      },
      {
        ...
        "price": 29.95,
        "description": "Faux leather material for style and comfort. 2 pockets of front, Button detail on waist.",
        "category": "women's clothing",
      ...
      },
      {
        ...
        "price": 39.99,
        "description": "Lightweight perfect for trip or casual wear. Adjustable drawstring waist design.",
        "category": "women's clothing",
        "images": ["https://fakestoreapi.com/img/71HblAHs5xL._AC_UY879_-2t.png"],
        "stock": 25
      },
      {
        "name": "Women's Solid Short Sleeve Boat Neck",
        "price": 9.85,
        "description": "Lightweight fabric with great stretch for comfort. Double stitching on bottom hem.",
        "category": "women's clothing",
      ...
      },
      {
        ...
        "price": 7.95,
        "description": "100% Polyester. Highly breathable with moisture wicking fabric. Slime fit.",
        "category": "women's clothing",
      ...
      },
      {
        ...
        "price": 12.99,
        "description": "Casual Short Sleeve Fashion Tee. The fabric is soft and has some stretch.",
        "category": "women's clothing",
