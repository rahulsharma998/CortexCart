...
def seed():
    ...
    dummy_products = [
      ...
      {"name": "Legends Naga Chain Bracelet", "price": 695, "description": "From our Legends Collection, inspired by the mythical water dragon that protects the ocean's pearl.", "category": "Jewelry", "images": ["https://fakestoreapi.com/img/71pWzhdJNwL._AC_UL640_QL65_ML3_t.png"], "stock": 15},
      {"name": "Solid Gold Petite Micropave", "price": 168, "description": "Satisfaction Guaranteed. Return or exchange any order within 30 days.", "category": "Jewelry", "images": ["https://fakestoreapi.com/img/61sbMiUnoGL._AC_UL640_QL65_ML3_t.png"], "stock": 25},
      {"name": "White Gold Plated Princess", "price": 9.99, "description": "Classic Created Wedding Engagement Solitaire Diamond Promise Ring for Her.", "category": "Jewelry", "images": ["https://fakestoreapi.com/img/71YAIFU48IL._AC_UL640_QL65_ML3_t.png"], "stock": 80},
      {"name": "Rose Gold Plated Earrings", "price": 10.99, "description": "Rose Gold Plated Double Flared Tunnel Plug Earrings. Made of 316L Stainless Steel.", "category": "Jewelry", "images": ["https://fakestoreapi.com/img/51UDEzMJVpL._AC_UL640_QL65_ML3_t.png"], "stock": 90},
